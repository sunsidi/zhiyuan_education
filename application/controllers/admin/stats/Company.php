...
class Company extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        if ($this->session->isLoggedIn) {
            ...
            $this->load->model('admin/stats/model_company');
            $this->lang->load('admin/stats/company_lang');
    ...
    public function index()
    {
        ...
        $this->load->view('admin/stats/company', $data);
        // set footer
    ...
    private function _getList()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => 'index.php/admin/stats/company',
        );
...
//        }
        ...
        $data['selected'] = array();
        $data['query'] = 'index.php/admin/stats/company/query?';
