          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($school['id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $school['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $school['id']; ?>" />
                    <?php } ?>
                  </td>
                  <td class="text-left"><?php echo $school['name']; ?></td>
                  <td class="text-right"><a href="<?php echo $school['edit']; ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
