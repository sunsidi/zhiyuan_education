                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php echo $column_name; ?> <i class="fa fa-angle-down">
                                </td>
                                <td class="text-center">
                                    <?php echo $column_upload_time ?> <i class="fa fa-angle-down">
                                </td>
                                <td class="text-center">
                                    <?php echo $column_decrypted_time ?> <i class="fa fa-angle-down">
                                </td>
                                <td class="text-center">
                                    <?php echo $column_upload_status ?> <i class="fa fa-angle-down">
                                </td>
                                <td class="text-center">
                                    <?php echo $column_filename ?>
                                </td>
                                <td class="text-center">
                                    <?php echo $column_size ?> <i class="fa fa-angle-down">
                                </td>
                                <td class="text-center">
                                    <?php echo $column_upload_number ?> <i class="fa fa-angle-down">
                                </td>
                                <td class="text-center">
                                    <?php echo $column_status ?>
                                </td>
                                <td class="text-center">
                                    <?php echo $column_error ?> <i class="fa fa-angle-down">
                                </td>
                            </tr>
                            </thead>
                            <tbody>
...
<!--                                </tr>-->
                                <tr>
                                    ...
                                    <td class="text-center"><a href="">第一期货(0001)</a></td>
                                    <td class="text-center">2019-04-18 12:00:00</td>
                                    <td class="text-center">2019-04-18 12:00:00</td>
                                    <td class="text-center">已上报</td>
                                    <td class="text-center"><a href="">0001clientinfo20190418.txt</a></td>
                                    <td class="text-center">100k</td>
                                    <td class="text-center">1</td>
                                    <td class="text-center">正确</td>
                                    <td class="text-center">这是一大串的复杂错误信息需要人来修改</td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
...
<script>
    $('.date').datetimepicker({
        ...
        // disabledDates: ['2019-04-17', '2019-04-19']
    });
</script>
